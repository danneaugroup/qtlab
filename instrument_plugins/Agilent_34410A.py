# Agilent 34410A.py driver for Agilent 34410A DMM
# Pieter de Groot <pieterdegroot@gmail.com>, 2008
# Martijn Schaafsma <qtlab@mcschaafsma.nl>, 2008
# Michiel Jol <jelle@michieljol.nl> 2009
# Reinier Heeres <reinier@heeres.eu>, 2008 - 2010
# Maximilian Thuermer <maximilian.thuermer@kit.edu> 2013
#
...
class Agilent_34410A(Instrument):
    ...
    Usage:
    Initialize with
    <name> = instruments.create('<name>', 'Agilent_34410A',
    ...
    def __init__(self, name, address, reset=False,
        ...
        logging.info('Initializing instrument Agilent_34410A')
        ...
        self.add_parameter('nplc',
            flags=Instrument.FLAG_GETSET,
            units='#', type=types.FloatType, minval=0.001, maxval=100)
