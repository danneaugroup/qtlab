# EGandG_Model5210.py class, to perform the communication between the Wrapper and the device
# Fan Wu, 2013
#
...
class EGandG_Model5210(Instrument):
   '''
   This is the driver for the Lockin

  Usage:
    Initialize with
    <name> = instruments.create('<name>', 'EGandG_Model5210', address='<GBIP address>, reset=<bool>')
   '''
   def __init__(self, name, address, reset=False):
      logging.info(__name__ + ' : Initializing instrument EG&G Model 5210')
